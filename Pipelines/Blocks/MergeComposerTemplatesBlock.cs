...
using Plugin.Sample.Composer.Template.Sync.Extensions;
...
namespace Plugin.Sample.GenericTaxes.Pipelines.Blocks
{
    ...
    public class MergeComposerTemplatesBlock : PipelineBlock<ImportComposerTemplatePipelineModel, ImportComposerTemplatePipelineModel, CommercePipelineExecutionContext>
    {
        /// <summary>
        /// Commerce Commander
        /// </summary>
